...
def _serialize_message(m: ChannelMessage, db: Session) -> dict:
    ...
    # Build reaction map: { emoji: { count, users: [user_id, ...] } }
...
# ------------------------------------------------------------------
# PATCH /channels/{channel_id}/messages/{message_id}  — edit
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# DELETE /channels/{channel_id}/messages/{message_id}  — soft delete
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# POST /channels/{channel_id}/messages/{message_id}/react  — toggle reaction
# ------------------------------------------------------------------
