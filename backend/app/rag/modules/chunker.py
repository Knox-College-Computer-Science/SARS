...
# Section heading used when a document has no Title elements
_NO_TITLE = "Document"
...
### Text chunking (hybrid: paragraph + semantic fallback) ###
...
def _semantic_split(text: str) -> list[str]:
    """
    Split a large paragraph at topic boundaries using cosine distance
...
def _split_sentences(text: str) -> list[str]:
    ...
    Protects common abbreviations from being treated as sentence ends.
    """
